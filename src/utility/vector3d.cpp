...
// constructor - construct a vector from a normal
Vector3D::Vector3D(const Normal &n) : x(n.x), y(n.y), z(n.z) {}

// constructor - constructs a vector from a point
// (used in the ConcaveHemisphere hit functions)
...
// assignment operator - assign a Normal to a vector
...
// assignment operator - assign a point to a vector
...
// normalize - converts the vector to a unit vector
...
// hat - converts the vector to a unit vector and returns the vector
