...
// class ViewPlane - sotres the number of horizontal and vertical pixels, as well as their size
// these pixels form a window through which the scene is rendered (chap 3: perpendicular to zw axis)
...
public:
    ...
    void set_hres(const int h_res); // set horizontal resolution
    void set_vres(const int v_res); // set vertical resolution
